...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/data/Run2017C/SingleMuon/MINIAOD/PromptReco-v3/000/300/742/00000/0AC61DCE-457E-E711-9CAE-02163E014217.root', 
...
process.patJetCorrFactorsTransientCorrectedUpdatedJECBTag = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
...
process.pfCombinedInclusiveSecondaryVertexV2BJetTagsUpdatedJECBTag = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosUpdatedJECBTag"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosUpdatedJECBTag"))
)


process.pfImpactParameterTagInfosUpdatedJECBTag = cms.EDProducer("CandIPProducer",
...
process.pfInclusiveSecondaryVertexFinderTagInfosUpdatedJECBTag = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterTagInfosUpdatedJECBTag"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfSecondaryVertexTagInfosUpdatedJECBTag = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
...
process.pfSimpleSecondaryVertexHighEffBJetTagsUpdatedJECBTag = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosUpdatedJECBTag"))
)
...
process.updatedPatJetsTransientCorrectedUpdatedJECBTag = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsUpdatedJECBTag"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsUpdatedJECBTag")),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsTransientCorrectedUpdatedJECBTag")),
    jetSource = cms.InputTag("updatedPatJetsUpdatedJECBTag"),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosUpdatedJECBTag"), cms.InputTag("pfSecondaryVertexTagInfosUpdatedJECBTag"), cms.InputTag("pfImpactParameterTagInfosUpdatedJECBTag")),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.selectedUpdatedPatJetsUpdatedJECBTag = cms.EDFilter("PATJetSelector",
    ...
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsTransientCorrectedUpdatedJECBTag")
)
...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_file:jec_DATA.db'),
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        cms.PSet(
            ...
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Fall17_17Nov2017BCDEF_V6_DATA_AK4PFPuppi')
        ))
)
